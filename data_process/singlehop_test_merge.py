...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_sources', default='nq,triviaqa,popqa')
    ...
    for data_source in data_sources:
        ...
        if data_source != 'strategyqa':
            ...
            dataset = datasets.load_dataset('json', data_files="/home/mnt/data/strategyqa/test_correct.jsonl")
    ...
    all_test_dataset.to_parquet(os.path.join(local_dir, 'singlehop_test_merged.parquet'))
