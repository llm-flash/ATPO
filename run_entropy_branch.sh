...
# ===================== Run Entropy Branch Training =====================
echo "Starting entropy branch training (vanilla GRPO + entropy branching)..."
bash /scratch/user/debajoym98_tamu.edu/ATPO/ATPO/scripts/entropy_branch.sh
