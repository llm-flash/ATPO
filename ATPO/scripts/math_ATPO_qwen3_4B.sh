...
TRAIN_FILES="/data1/jcarleton/ATPO/rl_datasets/math/train.parquet"
VALID_FILES=["/data1/jcarleton/ATPO/rl_datasets/math/test.parquet"]
...
CONDA_PATH="/net/home.itec.tamu.edu/mnt/itec-homes/jcarleton/.conda"
CONDA_ENV="atpo_code_tool"

# ============================ Reward Model Configuration ==========================
# Reward model settings. The custom reward function code used here comes from the lm-evaluation-harness repository
REWARD_MANAGER="naive"              # Reward manager type
CUSTOM_REWARD_FUNCTION_PATH="${PARENT_DIR}/verl_atpo/verl/utils/reward_score/math.py"
...
SAVE_PATH="/data1/jcarleton/ATPO/logs/${EXPERIMENT_NAME}/${CURRENT_DATE}/"
