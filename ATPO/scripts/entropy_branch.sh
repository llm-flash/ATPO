# Entropy Branching + Vanilla GRPO Credit Assignment
# Same tree expansion as ATPO_qwen3_4B.sh but with standard GRPO advantages
# instead of tree-based softmax credit assignment.
#
# Differences from ATPO_qwen3_4B.sh:
#   - EXPERIMENT_NAME: "entropy_branch_qwen3_4B" (separate W&B run)
#   - node_adv_mode: vanilla (standard GRPO, not node_value)
#   - leaf_value_norm: False (not used in vanilla mode, set explicitly for clarity)
#   - node_value_mode: child_mean (not used in vanilla mode, set explicitly for clarity)
...
# ============================ Basic Configuration ============================
PROJECT_NAME="ATPO"
EXPERIMENT_NAME="entropy_branch_qwen3_4B"
...
SEARCH_CACHE_PATH="/scratch/user/debajoym98_tamu.edu/ATPO/search_cache/search_cache_entropy_branch.json"
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.rollout.leaf_value_norm=False \
